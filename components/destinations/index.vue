...
<template>
  <section class="p-6 sm:p-20 sm:-mt-32 font-poppins">
    ...
    <div
      class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 my-12 px-4 sm:p-0"
    >
    <div>
        <nuxt-img
          format="webp"
          src="/images/falar.jpg"
          alt="Falar"
        ...
        >
          <div class="flex items-center justify-even space-x-2">
            ...
            <p class="text-gray-500 font-medium text-center w-full">Falar</p>
          </div>
        </div>
      </div>
      <div>
        ...
        >
          <div class="flex items-center justify-between font-poppins">
            <p class="text-gray-500 font-medium text-center w-full">Escrever</p>
          </div>
      ...
      <div>
        ...
        >
          <div class="flex items-center justify-even space-x-2">
            <p class="text-gray-500 font-medium text-center w-full">Escutar</p>
          </div>
        </div>
      </div>
      <div class="relative">
        ...
        >
          <div class="flex items-center justify-between font-poppins">
            <p class="text-gray-500 font-medium text-center w-full">Ler</p>
          </div>
        </div>
        <svg
